...
/// Scherm `topic-outage`: getoond wanneer de Europeana-raadpleging faalde
/// (niet-2xx, timeout, ongeldige JSON, of een ontbrekende/lege API-key). Er
/// verschijnt geen enkele claim; Wikidata wordt in dat geval niet apart
/// bevraagd omdat het Context-blok alleen samen met resultaten verschijnt.
class TopicOutageScreen extends StatelessWidget {
  const TopicOutageScreen({
  ...
  static const statusLabel = 'Europeana is tijdelijk niet geraadpleegd';
    ...
    return Column(
      ...
      children: [
        Align(
          ...
          child: FilledButton(
            key: const Key('topic-outage-retry'),
            onPressed: onRetry,
        ...
        Align(
          ...
          child: OutlinedButton(
            key: const Key('topic-outage-back-to-start'),
      ...
      children: [
        ...
        Card(
          child: ListTile(
            ...
            subtitle: const Text('Niet uitgevoerd · afhankelijk van Europeana'),
          ),
        ),
      ],
    );
