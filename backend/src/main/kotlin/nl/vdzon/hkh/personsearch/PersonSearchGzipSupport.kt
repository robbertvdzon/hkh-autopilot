...
/**
 * Vraagt `Accept-Encoding: gzip` op en zet een beschrijvende User-Agent-header; decomprimeert
 * transparant een gzip-gecodeerde respons, zodat de aanroeper altijd platte JSON-bytes leest.
 */
class GzipRequestInterceptor(private val userAgent: String) : ClientHttpRequestInterceptor {
