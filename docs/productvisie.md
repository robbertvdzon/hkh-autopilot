...
- **Toegankelijk:** historische kennis moet ook vindbaar zijn zonder vakkennis.
- **Nieuwsgierig:** ieder antwoord moet uitnodigen tot verder ontdekken.
- **Open:** waar mogelijk worden publieke bronnen en open standaarden gebruikt.
- **Herbruikbaar:** ontdekkingen moeten bruikbaar zijn voor verhalen, onderwijs, onderzoek en publicaties.
